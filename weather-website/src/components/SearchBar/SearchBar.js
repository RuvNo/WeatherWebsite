...
const SearchBar = (props) => {
    ...
    useEffect(() => {
        ...
        if (props.value.length === 0) {
            document.getElementById("clearButton").classList.add("empty")
        }
    ...
    return (
        <div>
            <div className="wrapper">
                ...
                <input className="search" placeholder="Search" type="text" id="SearchValue" value={props.value} onChange={handleInputChange} autoComplete="off"/>
